...
import { ContactingCustomerSupport, PartnershipInquiries } from "../data/data";
        ...
        <div className="row d-flex flex-row justify-content-end">
          <div className="col-md-6 col-xl-5">
            <h4 className="subHeading">
              <Link to="TrendingTopics">Contacting Customer Support</Link>
            </h4>
            {ContactingCustomerSupport.map((topic, index) => {
              return (
          ...
          <div className="col-md-6 col-xl-5 pt-5 pt-md-0">
            <h4 className="subHeading">
              <Link to="KhownIssues">Partnership Inquiries</Link>
            </h4>
            {PartnershipInquiries.map((knownIssue, index) => {
              return (
                <div className="articleLinks" key={index}>
